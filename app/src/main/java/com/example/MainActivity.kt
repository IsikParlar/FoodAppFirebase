...
import com.example.foodsapp.navigation.SayfaGecisleri
import com.example.foodsapp.ui.theme.FoodsAppTheme
import com.example.foodsapp.viewmodel.AnasayfaViewModel
...
fun Anasayfa(navController: NavController) {
    ...
    /*
        for (i in 1..6) {
            val yemek = when (i) {
                1 -> Yemekler(1, "Köfte", "kofte", 15)
                2 -> Yemekler(2, "Ayran", "ayran", 2)
                3 -> Yemekler(3, "Fanta", "fanta", 3)
                4 -> Yemekler(4, "Makarna", "makarna", 14)
                5 -> Yemekler(5, "Kadayıf", "kadayif", 8)
                6 -> Yemekler(6, "Baklava", "baklava", 15)
                else -> null // Geçerli olmayan bir indeks varsa null döndür
            }
            yemek?.let {
                yemekListesi.add(it) // null değilse listeye ekle
            }
        }
        */
                        ...
                        Card(modifier = Modifier
                            ...
                            Row(modifier = Modifier.clickable {
                                ...
                                Row(
                                    ...
                                    GlideImage(
                                        imageModel = { "https://raw.githubusercontent.com/isikparlar/survivalpackimages/main/${yemek.yemek_adi}.png" },
